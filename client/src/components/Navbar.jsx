      ...
      <div className="flex items-center justify-center gap-5">
        {!authUser && (
          <div className="hidden md:flex items-center md:gap-2">
            <button className="cursor-pointer border-2 border-transparent px-4 py-2 hover:bg-white/80 hover:text-black rounded-2xl font-semibold" onClick={()=>navigate('/login')}>
              Login
            </button>
            <button className="cursor-pointer bg-white/80 px-4 font-semibold py-2 rounded-2xl text-black border-2 border-transparent hover:border-white/80 hover:bg-transparent hover:text-white/80 transition-colors ease-in" onClick={()=>navigate('/signUp')}>
              Sign Up
            </button>
          </div>
        )}
        ...
        {authUser && (
          <div className="flex items-center justify-between gap-2 md:gap-4">
            <div className="flex items-center gap-1">
              ...
              <p className="text-[16px]">Hi, {authUser.username}</p>
            </div>
